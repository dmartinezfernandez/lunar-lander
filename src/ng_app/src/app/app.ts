...
@Component({
    ...
    template: `
        ...
        @if (finalState() == null) {
            ...
            <br><br><button type="button" (click)="reset()">&nbsp;Reset&nbsp;</button>
        }
    `,
    styles: [],
})
export class App {
    ...
    protected readonly lander = new Lander(this.initialState, -.001, 1.8);
    ...
    enter() {
        ...
        if (input) {
            ...
            for (let k of parts) {
                ...
                isTouchdown = this.lander.compute(k, 10);
            ...
            if (!isTouchdown && current.mass == current.dryMass) {
                ...
                this.lander.compute(0, 10); // returns true
                current = this.lander.getState();
